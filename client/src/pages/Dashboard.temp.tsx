      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="space-y-4">
            {[
              { stage: "New Leads", count: statusCounts["New"], widthPct: 30, color: "bg-blue-500" },
              { stage: "Contacted", count: statusCounts["Contacted"], widthPct: 50, color: "bg-amber-500" },
              { stage: "Qualified", count: statusCounts["Qualified"], widthPct: 65, color: "bg-violet-500" },
              { stage: "Proposal Sent", count: statusCounts["Proposal"], widthPct: 20, color: "bg-orange-500" },
              { stage: "Closed Won", count: statusCounts["Closed"], widthPct: 12.5, color: "bg-green-500" },
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="space-y-3">
            {[
              { name: "Arjun Singh", leads: 3, deals: "₹31,70,000", pct: 85, rank: 1, seed: "Arjun" },
              { name: "Neha Kapoor", leads: 2, deals: "₹14,50,000", pct: 70, rank: 2, seed: "Neha" },
              { name: "Meera Joshi", leads: 2, deals: "₹16,00,000", pct: 65, rank: 3, seed: "Meera" },
              { name: "Rohan Sharma", leads: 1, deals: "₹3,60,000", pct: 40, rank: 4, seed: "Rohan" },
