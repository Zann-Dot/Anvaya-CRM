...
export default function LeadsViewTabs() {
  return (
    <div className="inline-flex max-[400px]:w-full items-center max-[400px]:justify-between rounded-xl border border-gray-200 bg-gray-100 p-1 dark:border-gray-700 dark:bg-gray-800/80">
      {tabs.map(({ label, path, icon: Icon, end }) => (
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center text-nowrap gap-2 rounded-lg px-3.5 py-1.5 text-xs font-semibold transition-all duration-200 ${isActive
